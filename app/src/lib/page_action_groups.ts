...
export function buildPageActionGroups(params) {
  ...
  return {
    ...
    openers: {
      ...
      openInTerminalCmd: pageActions.openInTerminalCmd,
      openInTerminalPowerShell: pageActions.openInTerminalPowerShell,
      openInTerminalWsl: pageActions.openInTerminalWsl,
    ...
    selection: {
      ...
      canCutTargets: pageActions.canCutTargets,
      canRenameFocused: pageActions.canRenameFocused,
      canDeleteSelection: pageActions.canDeleteSelection,
      canDeleteTargets: pageActions.canDeleteTargets,
      canOpenPropertiesSelection: pageActions.canOpenPropertiesSelection,
      canZipCreateSelection: pageActions.canZipCreateSelection,
      canZipExtractSelection: pageActions.canZipExtractSelection,
      canZipExtractFocused: pageActions.canZipExtractFocused,
