...
export function buildViewInputStateFromVars(vars) {
  return {
    ...
    uiFileIconMode: vars.uiFileIconMode,
    loading: vars.loading,
    filteredEntries: vars.filteredEntries,
    pathCompletionPreviewActive: vars.pathCompletionPreviewActive,
...
export function buildViewInputActionsFromVars(vars) {
  return {
    ...
    handlePathCompletionSeparator: vars.handlePathCompletionSeparator,
    handlePathCompletionInputChange: vars.handlePathCompletionInputChange,
    clearPathCompletionPreview: vars.clearPathCompletionPreview,
